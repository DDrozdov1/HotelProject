...
namespace AppKursProject.Controllers
{
    public class RoomsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("RoomId,Type,Capacity,Description")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("RoomId,Type,Capacity,Description")] Room room)
        {
            if (id != room.RoomId)
            {
                return NotFound();
